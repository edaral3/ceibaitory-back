...
router.get('/billInformation/:nit', validateToken(['owner', 'admin', 'vendedor', 'seller']), setCollection('user'), user.getBillInformation)

router.get('/isBilling', validateToken(['owner', 'admin', 'vendedor', 'seller']), setCollection('user'), user.isCompanyBilling)
