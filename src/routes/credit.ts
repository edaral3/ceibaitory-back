...
router.post('/', validateToken(['owner', 'admin', 'vendedor']), validator('credit'), setCollection('credit'), credit.create)

router.put('/pay/:id', validateToken(['owner', 'admin', 'vendedor']), validator('payment'), setCollection('credit'), credit.pay)
...
router.get('/', validateToken(['owner', 'admin', 'vendedor']), setCollection('credit'), credit.getAll)
