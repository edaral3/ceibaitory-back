...
router.get('/:id', validateToken(['owner', 'admin', 'vendedor']), setCollection('store'), store.getOne)

router.get('/', validateToken(['owner', 'admin', 'vendedor']), setCollection('store'), store.getAll)
